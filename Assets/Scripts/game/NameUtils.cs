...
// echo $(shuf -n 1 newfirstwords.txt) $(shuf -n 1 newsecondwords.txt) $(shuf -n 1 lastw


        private string[] companyFirstWords = {
            "A",
            "A.",
            "A.G.",
            "ACT",
        ...
        private string[] companySecondWords = {
            "Ability",
            "Able",
            "About",
            "Abroad",
        ...
        private string[] companyThirdWords = {
            "Inc.",
            "Corp.",
            "Dynamics",
            "Incorporated",
        ...
        {
            return companyFirstWords[Random.Range(0,companyFirstWords.Length)] +
                " " + companySecondWords[Random.Range(0,companySecondWords.Length)] +
                " " + companyThirdWords[Random.Range(0,companyThirdWords.Length)];
        }
